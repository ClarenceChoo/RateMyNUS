#!/usr/bin/env python3
"""
Seed professor reviews from professor-reviews.json to Firestore
"""
import json
import os
...
def main():
    ...
    # Read professor reviews data
    script_dir = os.path.dirname(os.path.abspath(__file__))
    data_file = os.path.join(script_dir, "../data/professor-reviews.json")
    ...
    print(f"\nSuccessfully seeded {uploaded_count} professor reviews!")
